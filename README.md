...
Chemical Process Engineer bridging **Process Engineering** and **Data Science**. I build industrial-grade dashboards (Streamlit/Power BI), run discrete-event simulations to identify bottlenecks, and apply Lean Six Sigma & RCA to boost OEE and reduce losses. Certified in **GHG MRV (ISO 14064)** and currently pursuing Google certifications in Data Analytics and Project Management. Open to hybrid roles in manufacturing, mining, or the food industry.
